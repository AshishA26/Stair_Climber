...
#pragma config(Motor, motorB, MOTOR_BACK, tmotorEV3_Large, PIDControl, encoder)
#pragma config(Motor, motorC, MOTOR_BELT, tmotorEV3_Large, PIDControl, encoder)
...
void driveMotorsFrontBack(int motorPower)
{
	...
	motor[MOTOR_BACK] = -motorPower; //Back motor is backwards
	return;
}
...
void driveAllMotors(int motorPower)
{
	...
	motor[MOTOR_BACK] = (int)(-motorPower*0.5); //Back motor is backwards
	return;
}
